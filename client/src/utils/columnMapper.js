...
const FIELD_ALIASES = {
  ...
  contact_name: ['contact name', 'contact', 'primary contact', 'person', 'reference', 'referral'],
  ...
  contact_position: ['contact position', 'position', 'title', 'job title', 'role', 'reference role'],
  ...
  manager_name: ['manager name', 'manager', 'recommended contact', 'name', 'contact name'],
  owner_name: ['owner name', 'owner', 'recommended position', 'role'],
...
export const CRM_FIELDS = [
  ...
  { value: 'contact_name', label: 'Reference' },
  ...
  { value: 'manager_name', label: 'Name' },
  { value: 'owner_name', label: 'Role' },
