            ...
            <form onSubmit={handleSubmit}>
              <div className="modal-body">
                ...
                <div className="merge-field-help">
                  Available merge fields: <code>{'{{dispensary_name}}'}</code> <code>{'{{contact_name}}'}</code> (Name) <code>{'{{reference}}'}</code> (Reference) <code>{'{{contact_email}}'}</code> <code>{'{{dispensary_number}}'}</code> <code>{'{{contact_number}}'}</code> <code>{'{{current_pos_system}}'}</code> <code>{'{{address}}'}</code> <code>{'{{city}}'}</code> <code>{'{{state}}'}</code>
                </div>
              </div>
